...
namespace Assignment3_LHISGroup.Support_Classes
{
    ...
    class TaskTesting
    {
        ...
        {
            Wedding testWedding = new Wedding("Gay Rites", "notacakewalk", testClient1, testClient2, testStaff, new DateTime(2014, 1, 18), new DateTime(2014, 1, 22), Wedding.Status.InPreparation);
