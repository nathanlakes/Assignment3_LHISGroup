...
namespace Assignment3_LHISGroup.Reports
{
    public partial class EventProgress : Form
    {
        ...
        private void GenerateGraphBtn_Click(object sender, EventArgs e)
        {
            ...
            Support_Classes.Wedding testWedding = new Wedding("MARRIAGE", "controversial", testClient1, testClient2, testStaff, new DateTime(1, 8, 2015),
                new DateTime(30, 8, 2015),  Support_Classes.Wedding.Status.InPreparation);
            ...
            Support_Classes.Task testTask1 = new Support_Classes.Task("Task 1", "Help 1", Support_Classes.Task.Priority.low, new DateTime(2, 8, 2015), testStaff, testWedding);
            Support_Classes.Task testTask2 = new Support_Classes.Task("Task 2", "Help 2", Support_Classes.Task.Priority.low, new DateTime(4, 8, 2015), testStaff, testWedding);
            Support_Classes.Task testTask3 = new Support_Classes.Task("Task 3", "Help 3", Support_Classes.Task.Priority.low, new DateTime(15, 8, 2015), testStaff, testWedding);
            Support_Classes.Task testTask4 = new Support_Classes.Task("Task 4", "Help 4", Support_Classes.Task.Priority.low, new DateTime(17, 8, 2015), testStaff, testWedding);
            Support_Classes.Task testTask5 = new Support_Classes.Task("Task 5", "Help 5", Support_Classes.Task.Priority.low, new DateTime(20, 8, 2015), testStaff, testWedding);
